...
public class MoviesListViewModel
{
    ...
    public string WatchListIcon => IsInWatchList ? "fa fa-star fa-3x" : "fa fa-star-o fa-3x";

    public string WatchListMethod => IsInWatchList ? $"RemoveFromWatchList('{Id}')" : $"AddToWatchList('{Id}')";

    public string WatchListTitle => IsInWatchList ? "Remover da Lista" : "Adicionar à Lista";
}
// ReSharper restore NullableWarningSuppressionIsUsed
