...
- [x] Patron rulings C1/C2 (transitional scope), H1 (one pending `Status` AddColumn, no migration), H2 (T013a consumer fixes), and M2 (rename-on-contact scope) are encoded.
