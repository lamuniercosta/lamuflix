...
- [ ] T016 [SC-001] Run `dotnet build LamuFlix.sln`. Record exit code and warning count. Warning count must be **0** (base is 0 warnings at pickup base 1d9a616, G1). Depends on T015a.
